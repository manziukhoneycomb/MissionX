...
const UserManagement: React.FC<UserManagementProps> = () => {
  ...
  return (
    <Box sx={{ px: 3 }}>
      ...
      {!isLoading && (
        <TableContainer>
          <Table stickyHeader aria-label="tenant user table">
            <TableHead>
              <TableRow
                sx={{
                  '& th': {
                  ...
                  <TableCell colSpan={6} align="center" sx={{ py: 4 }}>
                    <Box sx={{ textAlign: 'center' }}>
                      ...
                      <Typography variant="body1" color="text.secondary">
                        No team members found. Invite your first user to get started.
                      </Typography>
                    </Box>
                  </TableCell>
                </TableRow>
      ...
      <Dialog
        ...
        <DialogTitle sx={{ borderBottom: `1px solid ${theme.palette.divider}` }}>
          {selectedUser ? 'Edit User Roles' : 'Invite New User'}
        </DialogTitle>
      ...
      <ConfirmationDialog
        ...
        message={`Are you sure you want to ${userToToggleStatus?.isActive ? 'deactivate' : 'activate'} ${userToToggleStatus?.email ?? ''}?`}
