...
export class CreateTeamsTables1764035514000 implements MigrationInterface {
    name = 'CreateTeamsTables1764035514000';
        ...
        await queryRunner.query(
            ...
            BEGIN
                IF NOT EXISTS (
                    ...
                    ALTER TABLE "teams" ADD CONSTRAINT "FK_teams_tenant_id" 
