...
import TeamManagementPage from '../modules/teams/team-management/TeamManagementPage';
import TeamDetail from '../modules/teams/components/TeamDetail';
import TeamManagementWrapper from '../modules/teams/components/TeamManagementWrapper';
      ...
      <TeamManagementWrapper>
        <Routes>
          <Route element={<MainLayout />}>
            ...
            <Route element={<ProtectedRoute requiredRoles={[ROLES.USER, ROLES.ADMIN, ROLES.SUPER_ADMIN]} />}>
