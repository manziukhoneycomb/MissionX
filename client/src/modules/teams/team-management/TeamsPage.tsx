...
type TeamsPageProps = Record<string, unknown>;
  ...
  return (
    <Box sx={{ backgroundColor: theme.palette.background.default }}>
      ...
      <Dialog
        ...
        <DialogContent sx={{ pt: 2 }}>
          {selectedTeamForMembers && <TeamMembersManager team={selectedTeamForMembers} />}
        </DialogContent>
      </Dialog>
      ...
      <ConfirmationDialog
        ...
        title="Delete Team"
        message={`Are you sure you want to delete this team? Members will be unassigned from the team. This action cannot be undone.`}
        confirmText="Delete"
