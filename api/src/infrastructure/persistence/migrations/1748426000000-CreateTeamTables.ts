...
export class CreateTeamTables1748426000000 implements MigrationInterface {
    name = 'CreateTeamTables1748426000000';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE INDEX IF NOT EXISTS "IDX_teams_name_tenant_id" ON "teams" ("name", "tenant_id")`,
        );
        ...
        const tableExists = await queryRunner.hasTable('teams');
        if (tableExists) {
            await queryRunner.query(
        ...
        const teamMembersExists = await queryRunner.hasTable('team_members');
        if (teamMembersExists) {
            ...
            await queryRunner.query(
                `ALTER TABLE "team_members" ADD CONSTRAINT "FK_team_members_role_id" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
            );
        }
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "team_members" DROP CONSTRAINT IF EXISTS "FK_team_members_role_id"`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_team_members_role_id"`);
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_teams_name_tenant_id"`);
