...
export class TeamController {
    ...
    async create(
        ...
        return this.teamCommands.create(createTeamDto, tenantId);
    }
    ...
    async findAll(@Req() req: RequestWithTenant): Promise<TeamDto[]> {
        ...
        return this.teamQueries.findAll(tenantId);
    }
    ...
    async findOne(@Param('id') id: string, @Req() req: RequestWithTenant): Promise<TeamDto> {
        ...
        return this.teamQueries.findById(id, tenantId);
    }
    ...
    async update(
        ...
        return this.teamCommands.update(id, updateTeamDto, tenantId);
    }
    ...
    async remove(@Param('id') id: string, @Req() req: RequestWithTenant): Promise<void> {
        ...
        return this.teamCommands.delete(id, tenantId);
    }
    ...
    async findMembers(
        ...
        return this.teamQueries.findMembers(id, tenantId);
    }
}
