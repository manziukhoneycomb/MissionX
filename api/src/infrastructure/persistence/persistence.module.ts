...
import { WEBHOOK_REPOSITORY } from '../../application/repositories/webhook.repository.interface';
import { WEBHOOK_EVENT_REPOSITORY } from '../../application/repositories/webhook-event.repository.interface';
import { WEBHOOK_LOG_REPOSITORY } from '../../application/repositories/webhook-log.repository.interface';

const entities = [Tenant, Role, User, Invoice, InvoiceItem, Webhook, WebhookEvent, WebhookLog];
